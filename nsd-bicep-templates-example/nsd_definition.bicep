...
param nfviSiteName string = 'test-nsdg_NFVI'
...
resource cgSchema 'Microsoft.Hybridnetwork/publishers/configurationGroupSchemas@2023-04-01-preview' = {
  parent: publisher
  name: 'test_nsdg_ConfigGroupSchema'
  location: location
  properties: {
    schemaDefinition: string(loadJsonContent('schemas/test_nsdg_ConfigGroupSchema.json'))
  }
}
...
resource nsdVersion 'Microsoft.Hybridnetwork/publishers/networkservicedesigngroups/networkservicedesignversions@2023-04-01-preview' = {
  ...
  location: location
  properties: {
    description: 'AI-assisted test NSD'
