...
resource cgValues 'Microsoft.HybridNetwork/configurationGroupValues@2023-04-01-preview' = {
  name: 'nfagent-cgvs'
  location: location
  properties: {
    publisherName: publisherName
    publisherScope: 'Private'
    configurationGroupSchemaName: cgSchema.name
...
// resource sns 'Microsoft.HybridNetwork/sitenetworkservices@2022-09-01-preview' = {
//   name: 'nfagent-sns'
//   location: location
//   // identity: {
//   //   type: 'UserAssigned'
