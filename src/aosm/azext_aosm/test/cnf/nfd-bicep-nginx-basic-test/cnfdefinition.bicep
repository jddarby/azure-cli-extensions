      ...
      networkFunctionApplications: [
        {
          ...
          deployParametersMappingRuleProfile: {
            ...
            helmMappingRuleProfile: {
              releaseNamespace: 'nfconfigchart'
              releaseName: 'nfconfigchart'
              helmPackageVersion: '0.1.0'
              values: string(loadJsonContent('configMappings/nfconfigchart-mappings.json'))
            }
          }
        }
      ]
